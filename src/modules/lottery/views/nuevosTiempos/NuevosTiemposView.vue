    ...
    <div class="game-layout-controls">
       ...
       <div v-if="!mobile" class="control-dates">
         ...
         <div class="control-select-dates">
           <SelectDate v-for="(date,index) of dates" :morningTime="morningTime" :nightTime="nightTime" :today="(index == 0) ? true : false" :default="defaultDateIndex" :key="index" @date-change="onDateChange" @time-change="onTimeChange" :times="times" :date="date.date" :weekDay="date.weekday" :index="index"/>
         </div>         
