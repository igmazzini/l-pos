<template>
  <div class="date-buttons">
      <button  :disabled="getDateDisabled()" :class="getActive()" @click.stop="onSelectDate">{{weekDay}} {{date}}</button>
      <button :disabled="getTimeDisabled(time)"  v-for="(time,index) of times" :key="index" :class="getTimeActive(index)" @click.stop="onSelectTime(index)">{{time}}</button>
  </div>
</template>
